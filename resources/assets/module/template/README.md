...
This module was generated by [Builder extension](https://github.com/websemantics/entity_builder-extension#). All the builder settings for creating [Stream Entities](https://github.com/websemantics/entity_builder-extension#what-is-an-entity) can be found at `resources/config/builder.php`.
